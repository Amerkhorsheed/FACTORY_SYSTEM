...
<x-card>
    <dl class="grid gap-4 sm:grid-cols-2">
        <div><dt class="text-xs text-slate-500">{{ __('admin.log') }}</dt><dd class="font-bold">{{ $activity->log_name }}</dd></div>
        <div><dt class="text-xs text-slate-500">{{ __('admin.event') }}</dt><dd class="font-bold">{{ $activity->event }}</dd></div>
        <div class="sm:col-span-2"><dt class="text-xs text-slate-500">{{ __('admin.description') }}</dt><dd class="font-bold">{{ $activity->description }}</dd></div>
    </dl>
